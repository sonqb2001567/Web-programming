...
<body class="bg-light d-flex justify-content-center position-relative" > <!--back-ground-->
    <div id="position-fixed template-holder-container" class="position-absolute top-0 start-0">
        ...
        <div id="templates-holder" class="position-fixed top-0 start-0" style="display: none;" onclick="tempPlateCloseButtonClick(this)">
            <div class="btn position-fixed">
                ...
                <div id="section">
                    <div id="wrapper-popup-action" class="position-relative" style=" border-width: 0.5px; border-style: none; border-color: #c8c8c8;"  onmouseover="hoverAdd(this)" onmouseout="outAdd(this)">
                        <div id="button-holder" class="position-absolute top-0 end-0 d-flex flex-column ps-3"> 
                            <div id="btn-action-add" class="btn btn-success m-1 btn-sm" style="display: none;">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-plus" viewBox="0 0 16 16">
                                    <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4"/>
                                </svg>
                                <span style="font-size: 12px;">Thêm</span>
                            </div>
                            <div id="btn-action-remove" class="btn btn-danger m-1 btn-sm" style="display: none;">
                        ...
                        <div id="section-item" class="d-flex flex-column">
                            <strong contenteditable="true">IELTS</strong>
