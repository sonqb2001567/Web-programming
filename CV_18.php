...
<div id="cv-form" class="mt-4 mb-4 bg-white d-flex flex-row"> <!--cv-form-->
    <div class="bg-secondary text-white w-50">  <!--Additional infor-->
        ...
        <img class="mt-2 ms-5" src="image/tranthib.jpg" alt="ava photo" width="150px" height="150px" style="border-radius: 50%;">
            ...
            <div id="section" class="">
                <div id="wrapper-popup-action" class="position-relative" style="border-width: 0.5px; border-style: hidden; border-color: rgb(200, 200, 200);" onmouseover="hoverAdd(this)" onmouseout="outAdd(this)">
                    ...
                    <div id="section-title" class="d-flex flex-row flex-wrap">
                        ...
                        <strong class="ms-2 fs-5" contenteditable="true">1 năm làm Marketing tại Công ty XYZ</strong>
                        <div id="date" class="d-flex flex-row align-self-center">
                            <div class="mx-2">from:</div>
                            <div contenteditable="true">
                                2025
