...
<div id="position-fixed template-holder-container" class="position-absolute top-0 start-0">
    ...
    <div class="d-flex flex-column w-100 justify-content-center m-0 p-0 ">
        <div class="name-input-container w-25 align-self-center">
            <div class="mb-3 mt-3">
                <p type="text" contenteditable="true" class="form-control" id="cv-name-input" placeholder="Enter your CV name">safgadsggasgsgagdg</p>
            </div>
        </div>
...
<div id="cv-form" class="mt-4 mb-4 bg-white d-flex flex-row align-self-center"> <!--cv-form-->
    ...
    <div class="text-black w-100 d-flex flex-column"> <!--main infor-->
        <div id="cv-element" class="fs-4">
            <strong contenteditable="true">fasfasfafasfasfA</strong>
        </div>
        <div id="cv-element" class="fs-4">
